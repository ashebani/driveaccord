<footer class="bg-white dark:bg-gray-900 ">
    <div class="container px-6 py-12 mx-auto max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            ...
            <div class="sm:col-span-2">
                ...
                <form
                    class="flex flex-col mx-auto mt-6 gap-2 space-y-3 md:space-y-0 md:flex-row"
                    action=""
                >
